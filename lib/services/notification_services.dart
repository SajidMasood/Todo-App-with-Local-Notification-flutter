...
class NotifyHelper {
  ...
  initializeNotification() async {
    //tz.initializeTimeZones(); this is iclude in this fun
...
//scheduledNotification() <-- before and after passing parameters-->
  ...
  tz.TZDateTime _convertTime(int hh, int mm) {
  ...
  Future onDidReceiveLocalNotification(
    ...
    Get.dialog(Text("Welcome into Flutter!"));
  }
}
